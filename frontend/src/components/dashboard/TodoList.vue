...
<div class="todo-list-container flex-1 overflow-y-auto pr-2 custom-scrollbar">
  <ul v-if="sortedTodos.length > 0" class="space-y-2">
    <li
      ...
      :key="todo.id"
      class="todo-item p-4 rounded-xl border border-transparent transition-all flex items-center justify-between group"
    ...
    >
      <div class="flex items-center gap-4 flex-1">
        ...
        <!-- Todo 텍스트 -->
        <span 
          class="todo-text flex-1 text-sm font-medium transition-all cursor-pointer"
