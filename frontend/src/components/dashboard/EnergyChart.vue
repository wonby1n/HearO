...
const batteryLevel = computed(() => {
  return Math.max(0, Math.min(100, agentStore.energyLevel || 0))
})
...
const refreshEnergyLevel = async () => {
  console.log('[EnergyChart] 새로고침 버튼 클릭 - 에너지 데이터 갱신')
  await dashboardStore.refreshEnergyData()
}
</script>
